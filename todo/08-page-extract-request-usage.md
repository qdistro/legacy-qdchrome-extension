# 08 — How to use `page.extract.request`
...
- `../../qdfirefox-extension/todo/09-page-extract-request-usage.md` — same doc on the Firefox side.
- `../../qdistro/todo/browser/02-page-extract-request-usage.md` — same doc on the bridge side (canonical).
- [07-bridge-protocol-alignment.md](07-bridge-protocol-alignment.md) — companion alignment effort that wired the bridge's general inbound surface.

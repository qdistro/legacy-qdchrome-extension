...
(function (root) {
  ...
  // with both the callback (Chromium) and Promise (Firefox) shapes of
  // tabs.get. Returns "" when the tab can't be resolved.
  ...
  // Runs in the page context. Mode-driven snapshot for the
  // bridge-initiated page.extract.request handler below.
  ...
  // Modes: selection / visible_text / full_text / outer_html /
  //        by_selector / title.
  // No intent token here — the bridge gates incoming D-Bus callers
  // via _identity_gate (peer selinux context). Symmetric with
